...
public static class ValueWithIntervalExtensions
{
    public static TimeInterval<TTime> ToTimeInterval<TTime>(this ImmutableArray<ValueWithInterval<TTime>> settings)
        where TTime : IComparable<TTime>, IArithmetic<TTime, TimeSpan> =>
        new(settings.GetStartTime(), settings.GetEndTime());
    
    public static TTime GetStartTime<TTime>(this ImmutableArray<ValueWithInterval<TTime>> settings)
        where TTime : IComparable<TTime>, IArithmetic<TTime, TimeSpan> =>
    ...
    public static TTime GetEndTime<TTime>(this ImmutableArray<ValueWithInterval<TTime>> settings)
        where TTime : IComparable<TTime>, IArithmetic<TTime, TimeSpan> =>
    ...
    public static bool HasOverlappingIntervals<TTime>(this ImmutableArray<ValueWithInterval<TTime>> settings)
        where TTime : IComparable<TTime>, IArithmetic<TTime, TimeSpan>
    {
        ReadOnlySpan<ValueWithInterval<TTime>> span = settings.AsSpan();
